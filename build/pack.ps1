...
dotnet pack src/TeamSpeak3.Metrics/TeamSpeak3.Metrics.csproj "--force" "--configuration=Release" "-p:Version=$Version"
dotnet pack src/TeamSpeak3.Metrics.AspNetCore/TeamSpeak3.Metrics.AspNetCore.csproj "--force" "--configuration=Release" "-p:Version=$Version"
